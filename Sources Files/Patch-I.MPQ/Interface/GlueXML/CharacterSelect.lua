...
function CharacterSelect_SelectCharacter(id, noCreate)
	if ( id == CharacterSelect.createIndex ) then
		...
		SetBackgroundModel(CharacterSelect, race, raceid);
		SelectCharacter(id);
	end
end
...
function UpdateCharacterSelectionPanel()
	local totalCharacters = GetNumCharacters();
	local name, race, class, level = GetCharacterInfo(CharacterSelect.selectedIndex);

	if (totalCharacters == 0) then
		CharacterSelectCharacterFrame:SetHeight(100);
	elseif (totalCharacters == 1) then
		CharacterSelectCharacterFrame:SetHeight(180);
	elseif (totalCharacters == 2) then
		CharacterSelectCharacterFrame:SetHeight(230);
	elseif (totalCharacters == 3) then
		CharacterSelectCharacterFrame:SetHeight(290);
	elseif (totalCharacters == 4) then
		CharacterSelectCharacterFrame:SetHeight(348);
	elseif (totalCharacters == 5) then
		CharacterSelectCharacterFrame:SetHeight(405);
	elseif (totalCharacters == 6) then
		CharacterSelectCharacterFrame:SetHeight(460);
	elseif (totalCharacters == 7) then
		CharacterSelectCharacterFrame:SetHeight(520);
	elseif (totalCharacters == 8) then
		CharacterSelectCharacterFrame:SetHeight(575);
	elseif (totalCharacters == 9) then
		CharacterSelectCharacterFrame:SetHeight(635);
	elseif (totalCharacters == 10) then
