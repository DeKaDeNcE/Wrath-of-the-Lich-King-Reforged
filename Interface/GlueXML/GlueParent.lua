...
function SetBackgroundModel(model, race, class)
  ...
  if (model == CharacterCreate) then
    ...
    if (GetSelectedRace() == 1) then
      name = 'Human';
    elseif (GetSelectedRace() == 2) then
      name = 'Dwarf';
    elseif (GetSelectedRace() == 3) then
      name = 'NightElf';
    elseif (GetSelectedRace() == 4) then
      name = 'Gnome';
    elseif (GetSelectedRace() == 5) then
      name = 'Draenei';
    -- elseif (GetSelectedRace() == 6) then
    --   name = 'Worgen';

    elseif (GetSelectedRace() == 6) then
      name = 'Orc';
    elseif (GetSelectedRace() == 7) then
      name = 'Scourge';
    elseif (GetSelectedRace() == 8) then
      name = 'Tauren';
    elseif (GetSelectedRace() == 9) then
      name = 'Troll';
    elseif (GetSelectedRace() == 10) then
      name = 'BloodElf';
    -- elseif (GetSelectedRace() == 12) then
    --   name = 'Goblin';
    end
    ...
    -- Draenei
  	elseif(--[[deDE]]race == "Draenei"or --[[enUS]]race == "Draenei"or --[[esES/esMX]]race == "Draenei"or --[[frFR]]race == "Draeneï") then
  		name = "Draenei";
  		character = true;
    -- elseif(--[[deDE]]race == "Worgen"or --[[enUS]]race == "Worgen"or --[[esES/esMX]]race == "Worgen"or --[[frFR]]race == "Worgen") then
  	-- 	name = "Worgen";
  	-- 	character = true;
    end
...
-- function SetBackgroundCreateModel(model, race)
-- 	local path="";
-- 	local character;
...
-- 	end
--
--   local path = "Interface\\Glues\\Models\\UI_"..race.."\\UI_"..race..".m2";
--
--   if ( model == CharacterCreate ) then
